...
这个管理后台，模仿的是 webman admin 的后台， 并不完美

<a href="<?=__url('user/')?>">用户基本注册登录页面在这里</a>
这是个很简陋的用户系统。提供了基本的用户接口。

<a href="<?=__url('app/admin/User/index')?>">用户管理后台在这里</a>
很简陋的用户管理系统。 没整合 webman admin 的用户管理后台。

<a href="<?=__url('blog/')?>">一个简单的博客系统</a> 这个是接入前后台管理系统的一个应用案例。
